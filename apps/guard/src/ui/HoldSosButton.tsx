...
//
// SOS is destructive-if-accidental, so it's HOLD-to-arm, not tap: press and hold
// for 1s while a red ring sweeps around the button's outline; only when the ring
// completes does the SOS fire. Releasing early cancels and the ring drains back.
...
export function HoldSosButton({ onArmed }: { onArmed: () => void }) {
